...
export class ContentFilter extends React.Component {
    ...
    */
    ...
    render(){
        const {onChange, placeholder, tags, filters, showAdditionalFilters, showAppliedFilters} = this.props;
        ...
        return (
            <div className={styles.container} ref={this.containerRef}>
                ...
                {showAppliedFilters &&
                    <AdditionalFiltersList filters={filters} onCloseClick={(filter)=>this.props.onCloseClick(filter)}/>
                }
                <ContentFilterMoreButton buttonClass={styles.button}
                                            ...
                                            popupChildren={
                                                <ContentFilterMorePopup tags={tags} onTagChange={this.handleTagChange} filters={filters}/>
                                            }
