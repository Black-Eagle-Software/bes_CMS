            ...
            <PageContent    isAutoSizerListContent={true}
                ...
                <div style={outerDivStyle}>
                    <div style={{ flex: "0 1 auto"}}>
                        <h2 style={{margin: "0.5em"}}>Album {this.props.match.params.id} details ({this.state.media.length})</h2>
                    </div>
                    <div style={{flex: "1 0 auto", display: "flex", flexFlow: "column nowrap"}}>
                        {!this.state.album_is_editing &&
                        ...
                        {!this.state.album_is_editing && this.state.media && this.state.media.length > 0 &&                            
                            <div style={{maxHeight: "100%", minHeight: "10%", flex: "1 0 auto"}}>
                        ...
                        {this.state.album_is_editing && this.state.temp_album_media && this.state.temp_album_media.length > 0 &&
                            <div style={{maxHeight: "50%", flex: "1 0 auto"}}>
                                <MediaTilesList media={this.state.temp_album_media} 
                                                onMediaInfoClick={(media)=>this.handleZoomMediaClick(media, this.state.temp_album_media)} 
                                                can_delete={true}
